              ...
              <div className="flex gap-3 pt-4 border-t border-border">
                {project.githubUrl && project.githubUrl.trim().length > 0 ? (
                  ...
                  <span
                    ...
                    className="inline-flex items-center justify-center w-10 h-10 rounded-lg border border-border bg-secondary/10 text-muted-foreground/60 cursor-not-allowed"
                  >
                    <Github size={18} />
                  </span>
                )}
